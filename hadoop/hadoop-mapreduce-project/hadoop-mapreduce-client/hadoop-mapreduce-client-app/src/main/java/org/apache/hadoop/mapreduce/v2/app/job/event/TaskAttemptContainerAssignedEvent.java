...
public class TaskAttemptContainerAssignedEvent extends TaskAttemptEvent {
  ...
  private boolean reusedContainer = false;
  ...
  public boolean isReusedContainer() {
    return reusedContainer;
  }

  public void setReusedContainer(boolean reusedContainer) {
    this.reusedContainer = reusedContainer;
  }
