...
public class PushDownManager {
    ...
    public scala.collection.Map<String, String> getZookeeperData(
        ...
        boolean saslEnable, String jaasConf, String krb5Conf) throws Exception {
    ...
    private static scala.collection.Map<String, String> javaMapToScala(Map zookeeperParams) {
        scala.collection.Map scalaMap = JavaConverters.mapAsScalaMap(zookeeperParams);
